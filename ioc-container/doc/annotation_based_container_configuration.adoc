...
[source,xml]
----
include::{resourcedir}/dependencies/annotation-based/annotation-based.xml[]
----
...
[source, java]
----
include::{sourcedir}/ch/wesr/spring/core/container/annotation/based/SpringBean.java[]
----


[source, java]
----
include::../src/main/java/ch/wesr/spring/core/container/annotation/based/SpringBean.java[]
----
